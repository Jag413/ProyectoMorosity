...
namespace TestEquifax
{
    ...
    ""applicants"": {
        ""primaryConsumer"": {
            ""personalInformation"": {
                ""idType"": ""SUSTITUIR POR TIPO DE IDENTIFICACI�N: ID / PASS"",
                ""idCode"": ""SUSTITUIR POR IDENTIFICACI�N"",
                ""addresses"": [
                    {
                    ""postalCode"": ""SUSTITUIR POR C�DIGO POSTAL""
                    }
                ]
            }
        }
  ...
  ""applicants"": {
    ""primaryConsumer"": {
      ""personalInformation"": {
        ""idType"": ""ID / PASS informado en la petici�n"",
        ""idCode"": ""Identificaci�n informada en la petici�n"",
        ""dateOfBirth"": ""Fecha de nacimiento informada en la petici�n"",
        ""addresses"": [
          {
            ""postalCode"": ""C�digo postal informado en la petici�n""
          }
        ]
      },
      ""dataSourceResponses"": {
    ...
    ""applicants"": {
        ""primaryConsumer"": {
            ""personalInformation"": {
                ...
                ""idCode"": ""N�MERO DE IDENTIFICADOR""
            },
            ""dataSourceResponses"": {
                ""EIPG"": {
                    ""ASNEFDETAIL"": {
